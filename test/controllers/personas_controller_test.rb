...
class PersonasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create persona" do
    assert_difference('Persona.count') do
      post personas_url, params: { persona: { age: @persona.age, email: @persona.email, name: @persona.name } }
    end
  ...
  test "should update persona" do
    patch persona_url(@persona), params: { persona: { age: @persona.age, email: @persona.email, name: @persona.name } }
